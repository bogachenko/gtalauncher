...
namespace gta_vc
{
    public partial class gta_vc : Form
    {
        ...
        {
            {
                ...
                {
                    MessageBox.Show("I can not find the gta_vc.exe file," +
                     "check its availability and try again.", "File not found", MessageBoxButtons.OK);
                    Close();
                }
            }
        }
        private void vcmp_Click(object sender, EventArgs e)
        {
            ...
            {
                DialogResult result = MessageBox.Show("It looks like you do not have VC-MP installed," +
